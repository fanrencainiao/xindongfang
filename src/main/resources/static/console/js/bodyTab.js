...
//				|| data[i].interfaceLogs || data[i].complaint || data[i].publicNum){
//                if(localStorage.getItem("role") == 4 || localStorage.getItem("role") == 7){
//                    continue;
//                }
//            }
//            // 客服过滤红包，直播
//			if(data[i].redEnvelope || data[i].live){
//        		if(localStorage.getItem("role") == 4){
//        			continue;
//				}
//			}
//			// 财务过滤群组，单聊记录
//            if(data[i].roomList || data[i].messageList){
...
//            }
	...
	Tab.prototype.render = function() {
		//显示左侧菜单
		var _this = this;
		$(".navBar ul").html('<li class="layui-nav-item layui-this"><a data-url="system_report.html"><i class="layui-icon" data-icon=""></i><cite>后台首页</cite></a></li>').append(_this.navBar(dataStr)).height($(window).height()-210);
