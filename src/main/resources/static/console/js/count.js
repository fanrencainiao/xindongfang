...
var  Count = {
	...
	loadUserRegisterCount : function (startDate,endDate,timeUnit){
		...
		Common.invoke({
		      path : request('/console/getUserRegisterCount'),
		      data : {
		      	startDate:startDate,
		      	endDate:endDate,
		      	timeUnit:timeUnit
...
/*	*//** 获取用户房间好友等总数量 **//*
	...
	/*loadChatMsgCount : function (startDate,endDate,timeUnit){
		...
		Common.invoke({
		      path : request('/console/chatMsgCount'),
		      data : {
		      	startDate:startDate,
		      	endDate:endDate,
		      	timeUnit:timeUnit
	...
	/*loadAddFriendsCount : function (startDate,endDate,timeUnit){
		...
		Common.invoke({
		      path : request('/console/addFriendsCount'),
		      data : {
		      	startDate:startDate,
		      	endDate:endDate,
		      	timeUnit:timeUnit
	...
	loadUserOnlineStatus : function(startDate,endDate,timeUnit){
		...
		Common.invoke({
		      path : request('/console/getUserStatusCount'),
		      data : {
		      	startDate:startDate,
		      	endDate:endDate,
		      	timeUnit:timeUnit
	...
	/*loadGroupMsgCount : function (roomJId,startDate,endDate,timeUnit){
		...
		Common.invoke({
		      path : request('/console/groupMsgCount'),
		      data : {
		    	roomId:roomJId,
		      	startDate:startDate,
		      	endDate:endDate,
	...
	/*loadAddRoomsCount : function (startDate,endDate,timeUnit){
		...
		Common.invoke({
		      path : request('/console/addRoomsCount'),
		      data : {
		      	startDate:startDate,
		      	endDate:endDate,
		      	timeUnit:timeUnit
